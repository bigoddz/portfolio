...
while True:
        ...
        if teamorind=="I":
            ...
            for a in range(0,21):
                print("type the name of the individuals in order that came 1st,2nd,3rd and 4th in the 1st event")
                order1=input()
        ...
        for x in range(0,4):
            print("type the name of the teams in order that came 1st,2nd,3rd and 4th in the 2nd event")
            print("teamnames are t1,t2,t3,t4")
            order2=input()
        ...
        for x in range(0,4):
            print("type the name of the teams in order that came 1st,2nd,3rd and 4th in the 3rd event")
            print("teamnames are t1,t2,t3,t4")
            order3=input()
        ...
        for x in range(0,4):
            print("type the name of the teams in order that came 1st,2nd,3rd and 4th in the 4th event")
            print("teamnames are t1,t2,t3,t4")
            order4=input()
